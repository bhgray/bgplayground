Ext.define('BGPlayground.view.dragdrop.DragPanelController', {
    extend: 'Ext.app.ViewController',

    alias: 'controller.drag-panel',
    // ISSUE
    // this won't compile for modern b/c Ext.window.Toast is not a modern
